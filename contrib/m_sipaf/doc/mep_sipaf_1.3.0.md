...
Rappatrier le module à la version voulue, puis installer les modules
...
Vérifier que les liens symboliques dans `<GeoNature>/backend/media/modulator sont toujours valides.
...
## MAJ du ref_geo, ajout des cannaux
...
- Etudier le changement de projection de la BDD...
