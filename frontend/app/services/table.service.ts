   ...
   */
      ...
      return [
        {
          ...
          tooltip: (cell) =>
            ...
            } ${this.getCellValue(cell, objectConfig)}`,
        },
        {
          headerSort: false,
          formatter: (cell, formatterParams, onRendered) => {
          ...
          tooltip: (cell) => {
            const editAllowed =
              ...
              moduleConfig.cruved["U"];
            return editAllowed
              ? `Éditer ${objectConfig.display.le_label} ${this.getCellValue(
                  cell, objectConfig
                )}`
              : "";
          },
    ...
    columns(layout, objectConfig) {
      ...
      return columns.map((col) => {
        ...
        column.headerFilter =
          column.headerFilter && layout.display_filters;
        // pour les dates
