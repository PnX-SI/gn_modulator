...
CREATE TABLE sipaf.t_passages_faune (
    ...
    id_nomenclature_ouvrage_hydro_banq_type INTEGER
);
...
---- sipaf.t_passages_faune foreign key constraint id_nomenclature_ouvrage_hydro_banq_type

ALTER TABLE sipaf.t_passages_faune
    ADD CONSTRAINT fk_sipaf_t_pas_t_nom_id_nomenclature_ouvrage_hydro_banq_type FOREIGN KEY (id_nomenclature_ouvrage_hydro_banq_type)
    REFERENCES ref_nomenclatures.t_nomenclatures(id_nomenclature)
    ON UPDATE CASCADE ON DELETE NO ACTION;
...
ALTER TABLE sipaf.t_passages_faune
        ...
        CHECK (ref_nomenclatures.check_nomenclature_type_by_mnemonique(id_nomenclature_ouvrage_hydro_banq_type,'PF_OH_BANQ_TYPE'))
        NOT VALID;
